...
composer: ## Run Composer command
	docker-compose -f ./.docker/docker-compose.yml -f ./.docker/docker-compose.dev.yml run --rm -w /var/www/app app composer $(a)

console: ## Run Symfony console command
	docker-compose -f ./.docker/docker-compose.yml -f ./.docker/docker-compose.dev.yml run -u www-data --rm -w /var/www/app app bin/console $(a)

phpunit: ## Run PHPunit command
	docker-compose -f ./.docker/docker-compose.yml -f ./.docker/docker-compose.dev.yml run --rm -w /var/www/app app ./vendor/bin/simple-phpunit $(a)

yarn: ## Run Yarn command
	docker-compose -f ./.docker/docker-compose.yml -f ./.docker/docker-compose.dev.yml -f ./.docker/docker-compose.node.yml run --rm -w /var/www/html node yarn $(a)

gulp: ## Run Gulp command
	docker-compose -f ./.docker/docker-compose.yml -f ./.docker/docker-compose.dev.yml -f ./.docker/docker-compose.node.yml run --rm -w /var/www/html node ./node_modules/.bin/gulp $(a)
