...
class LoadPostData implements FixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $post_2->setContent('Welcome to the new website Symfony.si. Page is interesting for PHP users of other frameworks and for those who have already used Symfony before. You will find useful advices and interesting information from Symfony world. Most of all you also have an opportunity to create this website along. It is open sourced and accessible on <a href="https://github.com/symfony-si/symfony.si">GitHub</a>. More Symfony information soon.
        ');
